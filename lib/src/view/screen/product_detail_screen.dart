                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: product.isAvailable ? () {
                            bool isSuccess = controller.addToCart(product);
                            showTopCenterMessage(
                              context,
                              isSuccess ? "Add successful" : "Add failed", // Customize the message based on success or failure
                              isSuccess ? AppColor.successMessage : AppColor.errorMessage, // Use dark orange for success, red for failure
                              isSuccess,
                            );
                          } : null,
